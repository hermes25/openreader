...
export default class Gallery extends Component {
  ...
  componentDidMount() {
    this.props.rimage.setGallery(this);
  }

  firstPage() {
    this.currentPage = 0;
    this.getViewPagerInstance().scrollToPage(this.currentPage, false);
  }
  ...
  nextPage() {
    ...
    if(this.currentPage < this.pageCount - 1) {
        this.getViewPagerInstance().scrollToPage(this.currentPage, true);
        return 1;
    } else {
      return 0;
    }
  ...
  shouldScrollViewPager(evt, gestureState) {
    ...
    if (dx < 0 && space.right <= 0) {
      this.props.rimage.nextChapter();
    } else if (dx > 0 && space.left <= 0) {
      this.props.rimage.preChapter();
    }
    return false;
  }
